...
export class PubSubManager {
    ...
    init = async (): Promise<PubSubManager> => {
        ...
        try {
            ...
            this.postgresNotifListenManager = new PostgresNotifListenManager(this.db, this.notifListener, full);
    ...
    */
    ...
    async addTrigger(params: { table_name: string; condition: string; }){
        try{
            ...
            /* Upsert condition */
            const app_id = await this.getAppID();
