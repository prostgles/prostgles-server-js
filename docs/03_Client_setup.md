...
<span style="color: green;">InitOptions</span>
  ...
  - **credentials** <span style="color: grey">optional</span> <span style="color: green;">RequestCredentials</span>
  - **redirect** <span style="color: grey">optional</span> <span style="color: green;">RequestRedirect</span>
